...
##Crie uma função recursiva que receba uma lista duplamente ligada e retorne como resultado uma nova lista duplamente ligada com os valores em ordem invertida. 
##Exemplo: se a lista passada como entrada for [1,2,3,4,5], ele deve retornar [5,4,3,2,1]. 
